    ...
    <header className="bg-gray-900 py-4 shadow-sm pt-7 border-2 border-t-0 border-r-0 border-l-0 ">
      <div className="container flex justify-between items-center relative px-2 md:px-8 align-middle">
        ...
        <div className="hidden lg:block ml-8">
          <a
            href="mailto:hosewellkaranja@gmail.com?subject=Hiring Hosewell Karanja&body=Dear Hosewell,%0D%0A%0D%0AWe are interested in hiring you for a project.%0D%0A%0D%0ABest regards,%0D%0A[Your Name]%0D%0A[Your Company Name]%0D%0A[Your Contact Information]"
