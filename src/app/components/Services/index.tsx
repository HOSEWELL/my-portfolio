...
const servicesData = [
  ...
  },
  {
    ...
    shortDescription: "Managing the entire product lifecycle, from ideation to delivery.",
    details: "I focus on defining product roadmaps, gathering requirements, and ensuring that your product meets customer needs through an efficient development process. I use agile methodologies and prioritize features based on user feedback and business goals.",
  },
  {
    title: "UX/UI Design",
