    ...
    <section id="about" className="py-20 bg-gray-50" style={{ fontFamily: "'Nunito', sans-serif" }}>
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          I am a passionate Fullstack Developer focused on creating meaningful, user-driven digital solutions. With a blend of innovation and expertise, I strive to elevate every project I work on.          </p>
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-16">
          ...
          <div className="md:w-1/2 flex flex-col items-center md:items-start space-y-6">
            ...
            <a
              href="https://wa.me/254115408139?text=Hello!%20I%27m%20interested%20in%20collaborating%20with%20you."
              target="_blank"
